 ...
 *   initialText – current message text
 *   onSave(messageId, newText) – async callback; parent calls API + updates state
 *   onCancel()  – closes the editor without saving
 */
const MessageEdit = ({ messageId, initialText, onSave, onCancel }) => {
