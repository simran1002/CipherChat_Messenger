...
export const getPresence = (value) => PRESENCE_OPTIONS.find((o) => o.value === value) || PRESENCE_OPTIONS[0];

const PresencePicker = ({ currentStatus = "available", currentNote = "", onUpdate, socket }) => {
